...
module.exports = new PluginWebpackConfig('org.graylog.plugins.pagerduty.PagerDutyNotificationPluginPlugin', loadBuildConfig(path.resolve(__dirname, './build.config')), {

    ...
    return (
      <React.Fragment>
        <Input id="pagerduty-notification-v1-routing_key"
               ...
               help={lodash.get(validation, 'errors.routing_key[0]', 'The Pager Duty integration Routing Key.')}
        ...
        <Input id="pagerduty-notification-v1-custom_incident"
               ...
               help={lodash.get(validation, 'errors.custom_incident[0]', 'Generate a custom incident key based on the Stream and the Alert Condition.')}
        ...
        <Input id="pagerduty-notification-v1-key_prefix"
               ...
               help={lodash.get(validation, 'errors.key_prefix[0]', 'Incident key prefix that identifies the incident.')}
        ...
        <Input id="pagerduty-notification-v1-client_name"
               ...
               help={lodash.get(validation, 'errors.client_name[0]', 'The name of the Graylog system that is triggering the PagerDuty event.')}
        ...
        <Input id="pagerduty-notification-v1-client_url"
               ...
               help={lodash.get(validation, 'errors.client_url[0]', 'The name of the Graylog system that is triggering the PagerDuty event.')}
